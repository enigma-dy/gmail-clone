const NAME_DATA = [
  {
    id: 1,
    name: "Tech Insider",
    title: "Unlocking AI Trends in 2024",
    body: "Discover the most anticipated trends in Artificial Intelligence for 2024. From AI ethics to quantum computing breakthroughs.",
    date: "Oct 22",
  },
  {
    id: 2,
    name: "DevCommunity",
    title: "10 JavaScript Frameworks to Watch",
    body: "A comprehensive guide to the top 10 JavaScript frameworks set to dominate in 2024.",
    date: "Oct 18",
  },
  {
    id: 3,
    name: "Daily Tech News",
    title: "Is Blockchain Still Relevant?",
    body: "An analysis of blockchain technology and whether it continues to have real-world applications in today’s tech landscape.",
    date: "Oct 15",
  },
  {
    id: 4,
    ...
    body: "Stay ahead of the game with these cloud security tips designed to protect your data in an increasingly interconnected world.",
    date: "Oct 10",
  },
  {
    id: 5,
    name: "AI Digest",
    title: "GPT-4 in Education: Opportunities and Challenges",
    body: "Explore how GPT-4 is transforming the educational sector, and the challenges it faces along the way.",
    date: "Oct 5",
  },
  {
    id: 6,
    ...
    body: "A deep dive into regular expressions and how to harness their full potential in programming.",
    date: "Oct 1",
  },
  {
    id: 7,
    name: "Next Level Coding",
    title: "Top Python Libraries for Data Science",
    body: "These are the Python libraries that every data scientist should know in 2024.",
    date: "Sep 27",
  },
  ,
  {
  ...
  },
  {
    id: 3,
    name: "Uche from Bolt",
    title: "Oluwagbenga, here’s a chance to save when you need to move",
  ...
  },
  {
    ...
    body: "NEW FORM SUBMISSION Hey there, Someone just submitted your form.  Here's what they had to say:",
    date: "12/23/20",
  },
  {
    id: 17,
